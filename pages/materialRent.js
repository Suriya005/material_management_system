      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex mb-2">
          ...
          <div className="flex basis-1/2">
            ...
            <input className="w-full outline-none border-solid border-2 rounded-md border-black mx-2 px-2 shadow-md" />
          </div>
        </div>
        <div className="flex mb-2">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-5 py-5 bg-white text-sm border-r-2 border-gray-200">
                    ...
                    <input type="number" className="text-gray-900 w-14 pl-1 mr-1 border-gray-900 border-2 rounded text-center " />
                    </div>
                  </td>
                  <td className="flex justify-center items-center px-5 py-5 bg-white text-sm">
